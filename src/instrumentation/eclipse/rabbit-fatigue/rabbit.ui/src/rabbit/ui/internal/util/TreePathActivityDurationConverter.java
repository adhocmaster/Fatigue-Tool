 ...
 */
public final class TreePathActivityDurationConverter implements IConverter<TreePath> {

  @Override
  public long convert(TreePath element) {
	for (int index = 0; index < element.getSegmentCount(); index ++) {
		Object obj = element.getSegment(index);
