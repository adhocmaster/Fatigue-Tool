 ...
 * 
 * <pre>
 * &lt;complexType name="focusEventListType">
 *   &lt;complexContent>
 *     &lt;extension base="{}eventGroupType">
 *       &lt;sequence>
 *         &lt;element name="focusEvent" type="{}focusEventListType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "focusEventListType", propOrder = {
    "focusEvent"
})
public class FocusEventListType
    extends EventGroupType
{

    @XmlElement(required = true)
    protected List<FocusEventType> focusEvent;
     ...
     * 
     */
    public List<FocusEventType> getFocusEvent() {
        if (focusEvent == null) {
        	focusEvent = new ArrayList<FocusEventType>();
        }
