 ...
 * 
 * <pre>
 * &lt;complexType name="navEventListType">
 *   &lt;complexContent>
 *     &lt;extension base="{}eventGroupType">
 *       &lt;sequence>
 *         &lt;element name="navEvent" type="{}navEventListType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "navEventListType", propOrder = {
    "navEvent"
})
public class NavEventListType
    extends EventGroupType
{

    @XmlElement(required = true)
    protected List<NavEventType> navEvent;
     ...
     * 
     */
    public List<NavEventType> getNavEvent() {
        if (navEvent == null) {
        	navEvent = new ArrayList<NavEventType>();
        }
