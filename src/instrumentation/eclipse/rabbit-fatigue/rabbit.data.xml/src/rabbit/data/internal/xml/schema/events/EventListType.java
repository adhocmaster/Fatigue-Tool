...
public class EventListType {
     ...
     * 
     */
    public List<ActivityEventListType> getActivityEvents() {
    ...
    /**
     * Gets the value of the projectEvents property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the projectEvents property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProjectEvents().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ProjectEventListType }
     * 
     * 
     */
    public List<ProjectEventListType> getProjectEvents() {
        if (projectEvents == null) {
        	projectEvents = new ArrayList<ProjectEventListType>();
        }
