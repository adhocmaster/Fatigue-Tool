...
public class ProjectData implements IProjectData {
   ...
   * @param projectSession The focus session.
   * * @param event The activity event.
   * @param count The count of the focus.
   * @throws NullPointerException If any of the arguments are null.
   */
  public ProjectData(LocalDate date, WorkspaceStorage workspace,
		String projectSession, String event, int count) {
	  data = new KeyMapBuilder()
      .put(DATE,      		   checkNotNull(date,      "date"))
      .put(WORKSPACE, 		   checkNotNull(workspace, "workspace"))
      .put(PROJECT_SESSION,    checkNotNull(projectSession,   "projectSession"))
