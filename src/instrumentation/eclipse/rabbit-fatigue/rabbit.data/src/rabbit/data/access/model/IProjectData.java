 ...
 * @noimplement
 */
public interface IProjectData extends IData {
   ...
   */
  public static final IKey<String> PROJECT_SESSION = Keys.PROJECT_SESSION;
  
  /**
   * Key for a focus session.
   */
  public static final IKey<String> EVENT = Keys.EVENT;
