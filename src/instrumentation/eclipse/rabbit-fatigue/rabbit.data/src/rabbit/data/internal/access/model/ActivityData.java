 ...
 */
public class ActivityData implements IActivityData {
   ...
   * @param editSpeed The files involved, or an empty collection.
   * @throws NullPointerException If any of the arguments are null.
   */
  public ActivityData(LocalDate date, WorkspaceStorage workspace,
		String activitySession, Duration duration, Double editSpeed) {
      ...
      .put(EDIT_SPEED,   	   checkNotNull(editSpeed,   "editSpeed"))
      .build();
  }
